...
- **`/gitlab-mcp`** routes GitLab work through an MCP-bound operator subagent. Reach for it whenever an issue, merge request, branch, pipeline, or project operation needs GitLab state.
